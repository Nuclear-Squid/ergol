...
:::{.toc .highlight}
- [4×6] <br> {{<keebicon type="4x6" href="#kbd_4x6">}} <br> facile et polyvalent
- [3×6] <br> {{<keebicon type="3x6" href="#kbd_3x6">}} <br> 1DFH par essence
- [3×5] <br> {{<keebicon type="3x5" href="#kbd_3x5">}} <br> la <i lang="en">red pill</i>
:::
